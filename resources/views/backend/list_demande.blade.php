                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr class="table-bordered">
                                        ...
                                        <td>Localite</td>
                                        @if ($demande->etat == 'D')
                                        <td><span class="badge bg-primary">{{ $statutDepose}}</span> </td>
                                        @elseif ($demande->etat == 'S')
                                        <td>{{ $statutSigne }}</td>
                                        @elseif ($demande->etat == 'A')
                                        <td>{{ $statutArchive }}</td>

                                        @elseif ($demande->etat == 'V')
                                        <td>{{ $statutValide }}</td>
                                        @elseif ($demande->etat == 'C')
                                        <td>{{ $statutComplement }}</td>
                                        @elseif ($demande->etat == 'R')
                                        <td>{{ $statutRejeter }}</td>
                                        @elseif ($demande->etat == 'E')
                                        <td>{{ $statutEtude }}</td>
                                        @endif
                                        <td>
                                            ...
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content" style="height: 500px;">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <a
                                                            href="{{ Storage::url($chemin->chemin) }}">{{$chemin->libelle}}</a>
                                                        <br>
                                                        @endforeach
