                ...
                @endif</p>
                    ...
                    <div class="row">
                        <div class="col-md-12 mx-0">
                                    <form id="msform" method="POST" action="{{route("demandesp009-store")}}" enctype="multipart/form-data" >
                                        @csrf
                                    ...
                                    <div class="form-card">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <input type="text" class="border-success form-control" value="{{ $name }}"  name="identite"
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <input type="text" class="border-success form-input" name="adresse_beneficiaire"
                                ...
                                <fieldset>
                                    <div class="form-card">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <label for="demande timbre" class="fw-bold">Permis de port d'arme <span style="color: red">*</span></label>
                                                <input type="file" class="form-control border-success" name="permis_arme">
                                            </div>
                                            <div class="col-6">
                                                <label for="demande timbre" class="fw-bold">Photo d'identité <span style="color: red">*</span></label>
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <label for="demande timbre" class="fw-bold">CNIB ou passeport <span style="color: red">*</span></label>
                                                <input type="file" class="form-control border-success" name="cnib_passport">
                                            </div>
                                            <div class="col-6">
                                                <label for="demande timbre" class="fw-bold">Document de l'arme <span style="color: red">*</span></label>
                                            <input type="file" class="form-control border-success" name="document_arme">
                                            </div>
