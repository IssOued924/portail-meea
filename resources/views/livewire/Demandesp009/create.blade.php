                                    ...
                                    <div class="form-card">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <input type="text" class="border-success form-control"   name="denomination_sociale_demandeur"
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <input type="text" class="border-success form-input" name="adresse_postale_demandeur"
