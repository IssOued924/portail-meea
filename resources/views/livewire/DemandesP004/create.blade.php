                        ...
                        <div class="col-md-12 mx-0">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <input type="text"   name="name"
                                                    placeholder="Votre nom" class="border-success form-control" />
                                            </div>
                                            <div class="col-6">
                                                <label class="nom_societe fw-bold"> <strong>Téléphone</strong> <span
                                                        style="color: red">*</span></label>
                                                <input type="text"   name="prenom"
                                                    placeholder="telephone" class="border-success form-control" />
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <label class="pays_residence fw-bold">Nom scientifique<span style="color:red">
                                                        *</span></label>
                                                <input type="text" name="nom_scientifique" class="border-success form-control" placeholder="Nom scientifique" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <label class="nom_societe fw-bold">Classe d'age<span
                                                        style="color: red">*</span></label>
                                                <input type="text" class="border-success" name="classe_age"
                                                    placeholder="Classe d'age" />
                                            </div>
                                            <div class="col-6">
                                                <label class="pays_residence fw-bold">Sexe animal<span style="color:red">
                                                        *</span></label>

                                                <select name="sexe" id="" class="border-success form-select">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <label class="nom_societe fw-bold">Lieu de provenance<span
                                                        style="color: red">*</span></label>
                                                <input type="text" class="border-success" name="lieu_provenance"
                                                    placeholder="Lieu provenance" />
                                            </div>
                                            <div class="col-6">
                                                <label class="pays_residence fw-bold">Conditions d'acquisition<span style="color:red">
                                                        *</span></label>
                                                <input type="text" name="conditions_acquisition" class="border-success form-control" placeholder="Conditions d'acquisition" />
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <textarea type="text" class="border-success" name="motif_detention"
                                                    placeholder="Motif de la detention" ></textarea>
                                            </div>
                                ...
                                <fieldset>
                                    <div class="form-card">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <label class="nom_societe  fw-bold">Condition de détention<span
                                                        style="color: red">*</span></label>

                                                <input type="file" class="border-success form-control" name="id_produit"
                                                     />
                                            </div>
                                            ...
                                            <div class="col-6">
                                                <label class="pays_residence fw-bold">Fichier certificat d'origine<span style="color:red">
                                                        *</span></label>
                                                        ...
                                                        <br/>
                                                <input type="file" name="appelation_commercial" class="form-control border-success"/>
                                            </div>
                                        </div><br>

                                        <div class="row">
                                            {{-- <div class="col-6">
                                                <label class="nom_societe fw-bold">Numero certificat sanitaire</label>
                                                <input type="text" class="border-success" name="formule_chimique"
                                                    placeholder="Numero certificat sanitaire" />
                                            </div> --}}
                                            <div class="col-6">
                                                <label class="pays_residence fw-bold">Fichier certificat sanitaire<span style="color:red">
                                                        *</span></label>
                                                        <br/>
                                                <input type="file" name="destination_pays" class="form-control border-success" />
                                            </div>
                                        </div>
