                        ...
                        <div class="col-md-12 mx-0">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <label class="pays_producteur fw-bold">Pays de production<span style="color:red">
                                                        *</span></label>
                                                <input type="text" name="pays_producteur" class="border-success"  placeholder="Pays de production" />
                                            </div>
                                            <div class="col-6">
                                                <label class="nom_producteur fw-bold">Nom du producteur<span style="color:red">
                                                        *</span></label>
                                                <input type="text" name="nom_producteur" placeholder="Nom du producteur" />
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <label class="adresse_producteur fw-bold">Adresse du producteur<span style="color:red">
                                                        *</span></label>
                                                <input type="text" name="adresse_producteur" placeholder="Adresse du producteur" />
                                            </div>
                                        </div>
                                ...
                                <fieldset>
                                    <div class="form-card">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <label class="delai  fw-bold">Délai de biodégradabilité en nomre de mois<span
                                                        style="color: red">*</span></label>
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <input type="text" class="border-success" name="poids"
                                                    placeholder="Poids unitaire du produit" />
                                            </div>
                                            <div class="col-6">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <label class="quantite_annuel fw-bold">Quantité annuelle de production ou d'importation<span
                                                        style="color: red">*</span></label>
                                                <input type="text" class="border-success" name="quantite_annuel"
                                                    placeholder="Quantité annuelle de production ou d'importation" />
                                            </div>
                                            <div class="col-6">
                                                <label class="pays_residence fw-bold">Certificat de biodégradabilité<span style="color:red">
                                                        *</span></label>
                                                <input type="file" class="form-control border-success" name="p007_1" placeholder="Certificat de biodégradabilité" />
                                            </div>
                                        </div>
                                    </div>
                                    <input type="button" name="previous" class="previous action-button-previous"
