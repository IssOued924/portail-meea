                ...
                @endif</p>
                    ...
                    <div class="row">
                        <div class="col-md-12 mx-0">
                                    <form id="msform" method="POST" action="{{route('demandesp003-store')}}" enctype="multipart/form-data" >
                                        @csrf
                                    ...
                                    <div class="form-card">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <input type="text" class="border-success form-control"  name="libelle_court"  placeholder="nom prenom"  /> <br /><br />
                                            </div>

                                            <div class="col-6">
                                                <label class="nom_societe fw-bold"> <strong>Téléphone</strong> <span style="color: red">*</span></label> <br />
                                                <input type="text" class="border-success form-control"   name="libelle_long"  placeholder="Prenom"   /> <br /><br />
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-3">
                                                    <label class="siege_social fw-bold ">Autre</label>
                                    ...
                                    <div class="form-card">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <input type="file"   class="form-control border-success "/> <br />
                                            </div>
                                            <div class="col-6">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <label class="siege_social fw-bold">Importez un échantillon des emballages <span style="color:red">*</span></label> <br />
                                                <input type="file"  class="form-control  border-success"/>
                                    ...
                                    <div class="form-card">
                                        ...
                                        <div class="row">
                                            <input type="checkbox" id="confirmationBox" name="confirmed"
                                                class="required-checkbox   checkbox" value="Confirmer">
