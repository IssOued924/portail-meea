...
class DemandeP0012Controller extends Controller
{
     ...
     DemandePieceP0012Repository $demandePieceP0012Repository, DemandeP0012 $demande)
    {
      ...
      //  dd($data['procedure_id']);
        ...
        $demandePieceP0012Repository->setChemin($cnib, $demande->uuid);
        $demandePieceP0012Repository->setChemin($photo, $demande->uuid);
        $demandePieceP0012Repository->setChemin($list_personne, $demande->uuid);
