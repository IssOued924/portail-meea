...
class DemandeP009Controller extends Controller
{
     ...
     DemandePieceP009Repository $demandePieceP009Repository, DemandeP009 $demande)
    {
       ...
       // $data['usager_id'] = Auth::user()->uuid;
        ...
        $demandePieceP009Repository->setChemin($permis_port_arme, $demande->uuid);
        $demandePieceP009Repository->setChemin($photo, $demande->uuid);
        $demandePieceP009Repository->setChemin($cnib_passport, $demande->uuid);
        $demandePieceP009Repository->setChemin($document_arme, $demande->uuid);
